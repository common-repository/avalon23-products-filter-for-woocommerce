'use strict';
class Avalon23_GeneratedSeoSettings extends Avalon23_GeneratedTables {
    constructor(table_data, table_html_id) {
        super(table_data, table_html_id);
        this.save_filter_field_action = 'avalon23_save_seo_settings_field';//reinit ajax action
        this.switcher_action = 'avalon23_save_seo_settings_field';
